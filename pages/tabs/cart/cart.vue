	...
	<view class="container">
		...
		<view v-else>
					...
					>
						...
						<view class="item-right">
							...
							<uni-number-box 
								class="step"
								:min="1" 
								:max="item.goods.stock_count"
								:value="item.number>item.goods.stock_count?item.goods.stock_count:item.number"
								:isMax="item.number>=item.goods.stock_count?true:false"
								:isMin="item.number===1"
								:index="index"
			...
			<view class="action-section">
				<view class="checkbox">
					<image 
						:src="allChecked?'http://cdn.mzyun.tech/shop/selected.png':'http://cdn.mzyun.tech/shop/select.png'" 
						mode="aspectFit"
						@click="check('all')"
					></image>
			...
			calcTotal(){
				...
				list.forEach(item=>{
					if(item.checked === true){
						total += item.goods.shop_price * item.number;
